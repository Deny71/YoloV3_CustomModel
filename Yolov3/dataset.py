...
class Dataset(object):
    ...
    def __init__(self, dataset_type, INPUT_SIZE, type):
        ...
        self.data_aug    = True if type == 1 else False
    ...
    def parse_annotation(self, annotation, mAP = 'False'):
        ...
        if self.data_aug:
            image = self.noise_maker(np.copy(image))# only for custom model learning
